...
open class T_R_ViewCell: BDCViewCell {
    ...
    override init(frame: CGRect) {
        ...
        let views = ["label": titleLabel, "radioButton": radioButton,  "line": separatorLine]
        
        // Define the contraints
        constraints += NSLayoutConstraint.constraints(withVisualFormat: "H:|-16-[label]-8-[radioButton(30)]-16-|", metrics: nil, views: views)
