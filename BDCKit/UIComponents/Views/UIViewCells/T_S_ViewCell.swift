...
//  BitcoinComWallet
//
//  Created by Jennifer Eve Curativo on 08/08/2019.
//  Copyright © 2019 Bitcoin.com. All rights reserved.
//

import UIKit

open class T_S_ViewCell: BDCViewCell {
    ...
    override init(frame: CGRect) {
        ...
        constraints += NSLayoutConstraint.constraints(withVisualFormat: "H:|-16-[label]-8-[subtitle]-34-|", metrics: nil, views: views)
